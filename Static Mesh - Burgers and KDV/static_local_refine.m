...
for i=1:nx-1
    ...
    if higherErr <= 1e-1    %check first threshold -> add 0 points
        nsubgrid = 2;
    elseif higherErr <= 1    %second threshold -> add 1 points
        nsubgrid = 3;
    elseif higherErr <= 3    %third threshold -> add 2 points
        nsubgrid = 4;
    elseif higherErr <= 6    %fourth threshold -> add 3 points
        nsubgrid = 5;
    elseif higherErr <= 10    %-> add 4 points
        nsubgrid = 6;
    elseif higherErr <= 15    %-> add 5 points
        nsubgrid = 7;
    elseif higherErr <= 20    %-> add 6 points
        nsubgrid = 8;
    elseif higherErr <= 30    %-> add 7 points
        nsubgrid = 9;
    elseif higherErr <= 40    %-> add 8 points
        nsubgrid = 10;
    elseif higherErr <= 50    %-> add 9 points
        nsubgrid = 11;
    elseif higherErr <= 60    %-> add 10 points
        nsubgrid = 12;
